...
#define MAG_CTRL_REG1 0x09 // Write register address
...
#define MMC5883MA_RESOLUTION 10
    ...
    void Device_Mag_getADC() {
    i2c_getSixRawADC(MAG_ADDRESS,MAG_DATA_REGISTER);
    MAG_ORIENTATION( ((rawADC[0]<<8) | rawADC[1])- 32768 ,          
                     ((rawADC[2]<<8) | rawADC[3])- 32768 ,     
                     ((rawADC[4]<<8) | rawADC[5])- 32768);
                     }
...
void Mag_init() {
 ...
 // i2c_writeReg(MAG_ADDRESS,MMC5883MA_INTERNAL_CONTROL_2,0x03);// Magnetometer continuous frequency settings
 ...
 // i2c_writeReg(MAG_ADDRESS,MMC5883MA_INTERNAL_CONTROL_1,0x01);
 //0x00 16bits 10ms 100Hz 
 //0x01 16bits 5ms 200Hz 
 //0x02 16bits 2.5ms 400Hz 
 //0x03 16bits 1.6ms 600Hz 

//i2c_writeReg(MAG_ADDRESS,MMC5883MA_INTERNAL_CONTROL_0,0x00);
//1 TM_M 
//0 TM_T 
//0 Start_MDT
//0 Set
...
//0 Test_Pin_Sel
  ...
  i2c_writeReg(MAG_ADDRESS,MMC5883MA_INTERNAL_CONTROL_2,0x03); 
   delay(120);
  i2c_writeReg(MAG_ADDRESS,MMC5883MA_INTERNAL_CONTROL_1,0x03);
    delay(120);
  i2c_writeReg(MAG_ADDRESS,MMC5883MA_INTERNAL_CONTROL_0,0x80);


  //i2c_writeReg(MAG_ADDRESS,MMC5883MA_INTERNAL_CONTROL_2,0x00); 
  //i2c_writeReg(MAG_ADDRESS,MMC5883MA_INTERNAL_CONTROL_1,0x01);
  //i2c_writeReg(MAG_ADDRESS,MMC5883MA_INTERNAL_CONTROL_0,0x80); 
